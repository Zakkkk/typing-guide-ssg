...
![The home row typing technique.](img/homerow.webp)
...
One massive advantage of using an [alternate keyboard layout](https://discord.gg/keyboard-layouts) is that you get all the benefits from complicated alt-fingering, without any of the mental effort required to plan this out and personalise it. It is much simpler to advise a general population to learn a modern alt layout than it is to advise them to work through all the common words, testing if each word is comfortable or not, not considering that a word may become uncomfortable down the line after speed has been gained.

Additionally, I believe that using a modern layout will make you a faster typist. Admittedly we have no studies or formalised trials on this, and this is just my personal opinion. The reason I believe a modern layout will improve your speed is because it is obvious that [worse layouts exist](https://layouts.wiki/layouts/2021/vitrimak/). This implies that some layouts are better than others. Modern layouts have far less same finger usage, awkward scissors and patterns, and far more rolls (try out the word `power` on your QWERTY keyboard!). I do not believe I could have reached my current speed, in the time that I did, on QWERTY, due to the discrepancy in rolls and same finger usage.
...
![Chart showing the amount of time taken to return to QWERTY speed.](img/return-to-qwerty.svg)

*"How long did it take you to return to your QWERTY speeds?" A survey was undertaken in the AKL Discord server. Speed of respondents ranged from ~40-200 wpm. There were 18 respondents.*
...
### "So, Which Layout Should I Learn?"
...
- [Rain](https://layouts.wiki/layouts/2024/rain/)
- [Night](https://www.valorance.org/night/)

[Or reading this article for choosing an alternative layout](https://layouts.wiki/guides/start/recommendations/). Additionally, you can also join [the AKL Discord](https://discord.gg/keyboard-layouts)!

To install a layout, please see the [layouts wiki guide](https://layouts.wiki/guides/start/software/).
